...
if __name__ == "__main__":
    ...
    def generate_data_list():
        ...
        for filename in os.listdir(image_dir):
            if filename.endswith('.jpg'):
                ...
                if os.path.exists(annotation_path):
                    image_list.append((image_path, annotation_path))
        
        # Scramble the data
        random.seed(seed)
        random.shuffle(image_list)
        
        # Split training and validation sets (9:1)
        ...
        train_lines = []
        for image_path, annotation_path in image_list[:train_size]:
            # Parse XML to get tags
            ...
            for obj in root.findall('object'):
                ...
                if name in class_map:
                    ...
                    labels.append(f"{xmin},{ymin},{xmax},{ymax},{class_idx}")
            if labels:
                line = f"{image_path} {' '.join(labels)}"
    ...
    # Generate data list
    train_lines, val_lines = generate_data_list()
